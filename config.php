...
// Update Config
define("LAST_DATA_UPDATE", "15/09/2021");
define("UPDATE_DATE_FORMAT", "m/d/Y");
define("LAST_DATA_FOR_DATE", "2021-2022 Fall ");
...
function generatePug($view, $title, $options = [], $prettyPrint = false){
    $initialOptions = [
		'title' => $title,
		'subdir' => SUBDIR,
		'homepageJS' => basename(glob("public/js/homepageFunctions.js")[0]),
		'progressLoaderJS' => basename(glob("public/js/progressLoaderFunctions.js")[0]),
		'scheduleViewerJS' => basename(glob("public/js/scheduleViewerFunctions.js")[0])
	];
